 ...
 */
public class TLRequestPaymentsConnectStarRefBot extends TLMethod<TLConnectedStarRefBots> {
    ...
    private final String _constructor = "payments.connectStarRefBot#0";

    public TLRequestPaymentsConnectStarRefBot() {
    }

    public TLRequestPaymentsConnectStarRefBot(TLAbsInputPeer peer, TLAbsInputUser bot) {
        this.peer = peer;
        this.bot = bot;
    }
