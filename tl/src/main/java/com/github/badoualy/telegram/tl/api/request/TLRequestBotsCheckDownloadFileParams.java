 ...
 */
public class TLRequestBotsCheckDownloadFileParams extends TLMethod<TLBool> {
    ...
    private final String _constructor = "bots.checkDownloadFileParams#0";

    public TLRequestBotsCheckDownloadFileParams() {
    }

    public TLRequestBotsCheckDownloadFileParams(TLAbsInputUser bot, String fileName, String url) {
        this.bot = bot;
