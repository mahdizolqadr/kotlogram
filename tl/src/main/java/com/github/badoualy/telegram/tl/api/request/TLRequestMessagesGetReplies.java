 ...
 */
public class TLRequestMessagesGetReplies extends TLMethod<TLAbsMessages> {
    ...
    private final String _constructor = "messages.getReplies#0";

    public TLRequestMessagesGetReplies() {
    }

    public TLRequestMessagesGetReplies(TLAbsInputPeer peer, int msgId, int offsetId, int offsetDate, int addOffset, int limit, int maxId, int minId, long hash) {
        this.peer = peer;
        this.msgId = msgId;
