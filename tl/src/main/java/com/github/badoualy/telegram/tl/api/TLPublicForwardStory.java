 ...
 */
public class TLPublicForwardStory extends TLAbsPublicForward {
    ...
    private final String _constructor = "publicForwardStory#0";

    public TLPublicForwardStory() {
    }

    public TLPublicForwardStory(TLAbsPeer peer, TLAbsStoryItem story) {
        this.peer = peer;
        this.story = story;
    }
