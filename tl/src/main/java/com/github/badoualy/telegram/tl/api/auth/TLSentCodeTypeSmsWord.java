 ...
 */
public class TLSentCodeTypeSmsWord extends TLAbsSentCodeType {
    ...
    private final String _constructor = "auth.sentCodeTypeSmsWord#0";

    public TLSentCodeTypeSmsWord() {
    }

    public TLSentCodeTypeSmsWord(String beginning) {
