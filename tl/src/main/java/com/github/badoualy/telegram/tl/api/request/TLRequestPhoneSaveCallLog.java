 ...
 */
public class TLRequestPhoneSaveCallLog extends TLMethod<TLBool> {
    ...
    private final String _constructor = "phone.saveCallLog#0";

    public TLRequestPhoneSaveCallLog() {
    }

    public TLRequestPhoneSaveCallLog(TLInputPhoneCall peer, TLAbsInputFile file) {
        this.peer = peer;
        this.file = file;
    }
