 ...
 */
public class TLStoryStats extends TLObject {
    ...
    private final String _constructor = "stats.storyStats#0";

    public TLStoryStats() {
    }

    public TLStoryStats(TLAbsStatsGraph viewsGraph, TLAbsStatsGraph reactionsByEmotionGraph) {
