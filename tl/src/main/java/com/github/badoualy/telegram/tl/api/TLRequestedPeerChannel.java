 ...
 */
public class TLRequestedPeerChannel extends TLAbsRequestedPeer {
    ...
    private final String _constructor = "requestedPeerChannel#0";

    public TLRequestedPeerChannel() {
    }

    public TLRequestedPeerChannel(long channelId, String title, String username, TLAbsPhoto photo) {
