 ...
 */
public class TLUpdateStory extends TLAbsUpdate {
    ...
    private final String _constructor = "updateStory#0";

    public TLUpdateStory() {
    }

    public TLUpdateStory(TLAbsPeer peer, TLAbsStoryItem story) {
        this.peer = peer;
        this.story = story;
    }
