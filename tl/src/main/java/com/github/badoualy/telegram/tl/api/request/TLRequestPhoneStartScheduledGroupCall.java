 ...
 */
public class TLRequestPhoneStartScheduledGroupCall extends TLMethod<TLAbsUpdates> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLInputGroupCall call;

    private final String _constructor = "phone.startScheduledGroupCall#0";

    public TLRequestPhoneStartScheduledGroupCall() {
    }

    public TLRequestPhoneStartScheduledGroupCall(TLInputGroupCall call) {
        this.call = call;
    }
