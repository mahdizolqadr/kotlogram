 ...
 */
public class TLMessageActionRequestedPeer extends TLAbsMessageAction {
    ...
    private final String _constructor = "messageActionRequestedPeer#0";

    public TLMessageActionRequestedPeer() {
    }

    public TLMessageActionRequestedPeer(int buttonId, TLVector<TLAbsPeer> peers) {
