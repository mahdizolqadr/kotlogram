 ...
 */
public class TLRequestPhoneLeaveGroupCallPresentation extends TLMethod<TLAbsUpdates> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLInputGroupCall call;

    private final String _constructor = "phone.leaveGroupCallPresentation#0";

    public TLRequestPhoneLeaveGroupCallPresentation() {
    }

    public TLRequestPhoneLeaveGroupCallPresentation(TLInputGroupCall call) {
        this.call = call;
    }
