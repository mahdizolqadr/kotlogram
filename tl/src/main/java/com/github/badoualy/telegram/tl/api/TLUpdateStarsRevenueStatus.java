 ...
 */
public class TLUpdateStarsRevenueStatus extends TLAbsUpdate {
    ...
    private final String _constructor = "updateStarsRevenueStatus#0";

    public TLUpdateStarsRevenueStatus() {
    }

    public TLUpdateStarsRevenueStatus(TLAbsPeer peer, TLStarsRevenueStatus status) {
        this.peer = peer;
        this.status = status;
    }
