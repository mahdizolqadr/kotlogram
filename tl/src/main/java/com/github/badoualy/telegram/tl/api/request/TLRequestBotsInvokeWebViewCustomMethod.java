 ...
 */
public class TLRequestBotsInvokeWebViewCustomMethod extends TLMethod<TLDataJSON> {
    ...
    private final String _constructor = "bots.invokeWebViewCustomMethod#0";

    public TLRequestBotsInvokeWebViewCustomMethod() {
    }

    public TLRequestBotsInvokeWebViewCustomMethod(TLAbsInputUser bot, String customMethod, TLDataJSON params) {
        this.bot = bot;
