 ...
 */
public class TLFoundStories extends TLObject {
    ...
    protected TLVector<TLFoundStory> stories;
    ...
    private final String _constructor = "stories.foundStories#0";

    public TLFoundStories() {
    }

    public TLFoundStories(int count, TLVector<TLFoundStory> stories, String nextOffset, TLVector<TLAbsChat> chats, TLVector<TLAbsUser> users) {
        this.count = count;
    ...
    public TLVector<TLFoundStory> getStories() {
        return stories;
    }

    public void setStories(TLVector<TLFoundStory> stories) {
        this.stories = stories;
    }
