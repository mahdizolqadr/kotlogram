 ...
 */
public class TLFoundStickers extends TLAbsFoundStickers {
    ...
    private final String _constructor = "messages.foundStickers#0";

    public TLFoundStickers() {
    }

    public TLFoundStickers(Integer nextOffset, long hash, TLVector<TLAbsDocument> stickers) {
