 ...
 */
public class TLRequestBotsAddPreviewMedia extends TLMethod<TLBotPreviewMedia> {
    ...
    private final String _constructor = "bots.addPreviewMedia#0";

    public TLRequestBotsAddPreviewMedia() {
    }

    public TLRequestBotsAddPreviewMedia(TLAbsInputUser bot, String langCode, TLAbsInputMedia media) {
        this.bot = bot;
