...
public class TLRequestMessagesEditInlineBotMessage extends TLMethod<TLBool> {
    ...
    public TLRequestMessagesEditInlineBotMessage(boolean noWebpage, boolean invertMedia, TLAbsInputBotInlineMessageID id, String message, TLAbsInputMedia media, TLAbsReplyMarkup replyMarkup, TLVector<TLAbsMessageEntity> entities) {
