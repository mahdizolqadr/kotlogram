 ...
 */
public class TLInputBotAppShortName extends TLAbsInputBotApp {
    ...
    private final String _constructor = "inputBotAppShortName#0";

    public TLInputBotAppShortName() {
    }

    public TLInputBotAppShortName(TLAbsInputUser botId, String shortName) {
        this.botId = botId;
