 ...
 */
public class TLRequestBotsSetBotGroupDefaultAdminRights extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLChatAdminRights adminRights;

    private final String _constructor = "bots.setBotGroupDefaultAdminRights#0";

    public TLRequestBotsSetBotGroupDefaultAdminRights() {
    }

    public TLRequestBotsSetBotGroupDefaultAdminRights(TLChatAdminRights adminRights) {
