 ...
 */
public class TLChannelAdminLogEventActionChangeEmojiStickerSet extends TLAbsChannelAdminLogEventAction {
    ...
    private final String _constructor = "channelAdminLogEventActionChangeEmojiStickerSet#0";

    public TLChannelAdminLogEventActionChangeEmojiStickerSet() {
    }

    public TLChannelAdminLogEventActionChangeEmojiStickerSet(TLAbsInputStickerSet prevStickerset, TLAbsInputStickerSet newStickerset) {
