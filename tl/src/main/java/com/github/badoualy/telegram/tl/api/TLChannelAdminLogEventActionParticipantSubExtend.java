 ...
 */
public class TLChannelAdminLogEventActionParticipantSubExtend extends TLAbsChannelAdminLogEventAction {
    ...
    private final String _constructor = "channelAdminLogEventActionParticipantSubExtend#0";

    public TLChannelAdminLogEventActionParticipantSubExtend() {
    }

    public TLChannelAdminLogEventActionParticipantSubExtend(TLAbsChannelParticipant prevParticipant, TLAbsChannelParticipant newParticipant) {
