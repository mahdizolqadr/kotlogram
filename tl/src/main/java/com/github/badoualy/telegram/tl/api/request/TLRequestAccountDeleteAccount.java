...
public class TLRequestAccountDeleteAccount extends TLMethod<TLBool> {
    ...
    public TLRequestAccountDeleteAccount(String reason, TLAbsInputCheckPasswordSRP password) {
        this.reason = reason;
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        password = (flags & 1) != 0 ? readTLObject(stream, context, TLAbsInputCheckPasswordSRP.class, -1) : null;
    }
