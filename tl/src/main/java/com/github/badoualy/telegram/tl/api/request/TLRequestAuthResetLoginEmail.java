 ...
 */
public class TLRequestAuthResetLoginEmail extends TLMethod<TLAbsSentCode> {
    ...
    private final String _constructor = "auth.resetLoginEmail#0";

    public TLRequestAuthResetLoginEmail() {
    }

    public TLRequestAuthResetLoginEmail(String phoneNumber, String phoneCodeHash) {
