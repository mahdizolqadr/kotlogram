 ...
 */
public class TLRequestChannelsSetEmojiStickers extends TLMethod<TLBool> {
    ...
    private final String _constructor = "channels.setEmojiStickers#0";

    public TLRequestChannelsSetEmojiStickers() {
    }

    public TLRequestChannelsSetEmojiStickers(TLAbsInputChannel channel, TLAbsInputStickerSet stickerset) {
