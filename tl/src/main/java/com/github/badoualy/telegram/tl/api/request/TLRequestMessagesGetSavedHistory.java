 ...
 */
public class TLRequestMessagesGetSavedHistory extends TLMethod<TLAbsMessages> {
    ...
    private final String _constructor = "messages.getSavedHistory#0";

    public TLRequestMessagesGetSavedHistory() {
    }

    public TLRequestMessagesGetSavedHistory(TLAbsInputPeer peer, int offsetId, int offsetDate, int addOffset, int limit, int maxId, int minId, long hash) {
        this.peer = peer;
