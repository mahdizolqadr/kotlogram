 ...
 */
public class TLRequestMessagesSetDefaultReaction extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLAbsReaction reaction;

    private final String _constructor = "messages.setDefaultReaction#0";

    public TLRequestMessagesSetDefaultReaction() {
    }

    public TLRequestMessagesSetDefaultReaction(TLAbsReaction reaction) {
