 ...
 */
public class TLRequestChatlistsJoinChatlistUpdates extends TLMethod<TLAbsUpdates> {
    ...
    private final String _constructor = "chatlists.joinChatlistUpdates#0";

    public TLRequestChatlistsJoinChatlistUpdates() {
    }

    public TLRequestChatlistsJoinChatlistUpdates(TLInputChatlistDialogFilter chatlist, TLVector<TLAbsInputPeer> peers) {
