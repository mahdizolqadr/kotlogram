 ...
 */
public class TLRequestChatlistsJoinChatlistInvite extends TLMethod<TLAbsUpdates> {
    ...
    private final String _constructor = "chatlists.joinChatlistInvite#0";

    public TLRequestChatlistsJoinChatlistInvite() {
    }

    public TLRequestChatlistsJoinChatlistInvite(String slug, TLVector<TLAbsInputPeer> peers) {
        this.slug = slug;
        this.peers = peers;
    }
