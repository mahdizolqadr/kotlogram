 ...
 */
public class TLRequestStickersDeleteStickerSet extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLAbsInputStickerSet stickerset;

    private final String _constructor = "stickers.deleteStickerSet#0";

    public TLRequestStickersDeleteStickerSet() {
    }

    public TLRequestStickersDeleteStickerSet(TLAbsInputStickerSet stickerset) {
