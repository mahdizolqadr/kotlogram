 ...
 */
public class TLSentCodeSuccess extends TLAbsSentCode {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLAbsAuthorization authorization;

    private final String _constructor = "auth.sentCodeSuccess#0";

    public TLSentCodeSuccess() {
    }

    public TLSentCodeSuccess(TLAbsAuthorization authorization) {
