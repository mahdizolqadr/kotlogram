 ...
 */
public class TLBusinessRecipients extends TLObject {
    ...
    private final String _constructor = "businessRecipients#0";

    public TLBusinessRecipients() {
    }

    public TLBusinessRecipients(boolean existingChats, boolean newChats, boolean contacts, boolean nonContacts, boolean excludeSelected, TLLongVector users) {
