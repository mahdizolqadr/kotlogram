...
public class TLInputBotInlineMessageText extends TLAbsInputBotInlineMessage {
    ...
    public TLInputBotInlineMessageText(boolean noWebpage, boolean invertMedia, String message, TLVector<TLAbsMessageEntity> entities, TLAbsReplyMarkup replyMarkup) {
