 ...
 */
public class TLStarsGiftOption extends TLObject {
    ...
    private final String _constructor = "starsGiftOption#0";

    public TLStarsGiftOption() {
    }

    public TLStarsGiftOption(boolean extended, long stars, String storeProduct, String currency, long amount) {
