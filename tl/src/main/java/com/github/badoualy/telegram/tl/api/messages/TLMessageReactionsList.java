...
public class TLMessageReactionsList extends TLObject {
    ...
    protected TLVector<TLMessagePeerReaction> reactions;
    ...
    private final String _constructor = "messages.messageReactionsList#0";

    public TLMessageReactionsList() {
    }

    public TLMessageReactionsList(int count, TLVector<TLMessagePeerReaction> reactions, TLVector<TLAbsChat> chats, TLVector<TLAbsUser> users, String nextOffset) {
        this.count = count;
    ...
    public TLVector<TLMessagePeerReaction> getReactions() {
        return reactions;
    }

    public void setReactions(TLVector<TLMessagePeerReaction> reactions) {
        this.reactions = reactions;
    }
