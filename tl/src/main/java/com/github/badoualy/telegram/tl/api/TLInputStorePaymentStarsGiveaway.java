 ...
 */
public class TLInputStorePaymentStarsGiveaway extends TLAbsInputStorePaymentPurpose {
    ...
    private final String _constructor = "inputStorePaymentStarsGiveaway#0";

    public TLInputStorePaymentStarsGiveaway() {
    }

    public TLInputStorePaymentStarsGiveaway(boolean onlyNewSubscribers, boolean winnersAreVisible, long stars, TLAbsInputPeer boostPeer, TLVector<TLAbsInputPeer> additionalPeers, TLStringVector countriesIso2, String prizeDescription, long randomId, int untilDate, String currency, long amount, int users) {
