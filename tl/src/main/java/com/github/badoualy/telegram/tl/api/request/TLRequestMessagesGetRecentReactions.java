 ...
 */
public class TLRequestMessagesGetRecentReactions extends TLMethod<TLAbsReactions> {
    ...
    private final String _constructor = "messages.getRecentReactions#0";

    public TLRequestMessagesGetRecentReactions() {
    }

    public TLRequestMessagesGetRecentReactions(int limit, long hash) {
        this.limit = limit;
        this.hash = hash;
    }
