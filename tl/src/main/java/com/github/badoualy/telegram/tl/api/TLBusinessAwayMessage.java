 ...
 */
public class TLBusinessAwayMessage extends TLObject {
    ...
    private final String _constructor = "businessAwayMessage#0";

    public TLBusinessAwayMessage() {
    }

    public TLBusinessAwayMessage(boolean offlineOnly, int shortcutId, TLAbsBusinessAwayMessageSchedule schedule, TLBusinessRecipients recipients) {
