 ...
 */
public class TLUpdateDeleteQuickReplyMessages extends TLAbsUpdate {
    ...
    private final String _constructor = "updateDeleteQuickReplyMessages#0";

    public TLUpdateDeleteQuickReplyMessages() {
    }

    public TLUpdateDeleteQuickReplyMessages(int shortcutId, TLIntVector messages) {
