 ...
 */
public class TLRequestAccountGetGlobalPrivacySettings extends TLMethod<TLGlobalPrivacySettings> {
    public static final int CONSTRUCTOR_ID = 0x0;

    private final String _constructor = "account.getGlobalPrivacySettings#0";

    public TLRequestAccountGetGlobalPrivacySettings() {
    }
