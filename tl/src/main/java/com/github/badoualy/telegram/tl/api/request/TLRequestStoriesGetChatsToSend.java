 ...
 */
public class TLRequestStoriesGetChatsToSend extends TLMethod<TLAbsChats> {
    public static final int CONSTRUCTOR_ID = 0x0;

    private final String _constructor = "stories.getChatsToSend#0";

    public TLRequestStoriesGetChatsToSend() {
    }
