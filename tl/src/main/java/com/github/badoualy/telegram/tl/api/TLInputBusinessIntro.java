 ...
 */
public class TLInputBusinessIntro extends TLObject {
    ...
    private final String _constructor = "inputBusinessIntro#0";

    public TLInputBusinessIntro() {
    }

    public TLInputBusinessIntro(String title, String description, TLAbsInputDocument sticker) {
        this.title = title;
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        sticker = (flags & 1) != 0 ? readTLObject(stream, context, TLAbsInputDocument.class, -1) : null;
    }
