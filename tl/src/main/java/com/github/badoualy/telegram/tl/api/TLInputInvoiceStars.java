 ...
 */
public class TLInputInvoiceStars extends TLAbsInputInvoice {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLAbsInputStorePaymentPurpose purpose;

    private final String _constructor = "inputInvoiceStars#0";

    public TLInputInvoiceStars() {
    }

    public TLInputInvoiceStars(TLAbsInputStorePaymentPurpose purpose) {
