 ...
 */
public class TLRequestChatlistsHideChatlistUpdates extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLInputChatlistDialogFilter chatlist;

    private final String _constructor = "chatlists.hideChatlistUpdates#0";

    public TLRequestChatlistsHideChatlistUpdates() {
    }

    public TLRequestChatlistsHideChatlistUpdates(TLInputChatlistDialogFilter chatlist) {
