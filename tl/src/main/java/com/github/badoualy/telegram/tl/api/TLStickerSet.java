...
public class TLStickerSet extends TLObject {
    ...
    public TLStickerSet(boolean archived, boolean official, boolean masks, boolean animated, boolean videos,
                        Integer installedDate, long id, long accessHash, String title, String shortName,
                        TLVector<TLAbsPhotoSize> thumbs, Integer thumbDcId, Integer thumbVersion, int count, int hash) {
    ...
    public void serializeBody(OutputStream stream) throws IOException {
        ...
        if ((flags & 1) != 0) {
            if (installedDate == null) {
                throwNullFieldException("installedDate", flags);
            }
        ...
        if ((flags & 16) != 0) {
            ...
            if (thumbDcId == null) {
                throwNullFieldException("thumbDcId", flags);
            }
            if (thumbVersion == null) {
                throwNullFieldException("thumbVersion", flags);
            }
