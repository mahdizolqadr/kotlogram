 ...
 */
public class TLRequestAccountGetReactionsNotifySettings extends TLMethod<TLReactionsNotifySettings> {
    public static final int CONSTRUCTOR_ID = 0x0;

    private final String _constructor = "account.getReactionsNotifySettings#0";

    public TLRequestAccountGetReactionsNotifySettings() {
    }
