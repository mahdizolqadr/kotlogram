 ...
 */
public class TLRequestAccountGetChatThemes extends TLMethod<TLAbsThemes> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected long hash;

    private final String _constructor = "account.getChatThemes#0";

    public TLRequestAccountGetChatThemes() {
    }

    public TLRequestAccountGetChatThemes(long hash) {
        this.hash = hash;
    }
