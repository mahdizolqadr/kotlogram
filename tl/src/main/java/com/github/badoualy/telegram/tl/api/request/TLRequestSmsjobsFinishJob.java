 ...
 */
public class TLRequestSmsjobsFinishJob extends TLMethod<TLBool> {
    ...
    private final String _constructor = "smsjobs.finishJob#0";

    public TLRequestSmsjobsFinishJob() {
    }

    public TLRequestSmsjobsFinishJob(String jobId, String error) {
        this.jobId = jobId;
        this.error = error;
    }
