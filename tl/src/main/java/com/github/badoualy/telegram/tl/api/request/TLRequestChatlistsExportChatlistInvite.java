 ...
 */
public class TLRequestChatlistsExportChatlistInvite extends TLMethod<TLExportedChatlistInvite> {
    ...
    private final String _constructor = "chatlists.exportChatlistInvite#0";

    public TLRequestChatlistsExportChatlistInvite() {
    }

    public TLRequestChatlistsExportChatlistInvite(TLInputChatlistDialogFilter chatlist, String title, TLVector<TLAbsInputPeer> peers) {
