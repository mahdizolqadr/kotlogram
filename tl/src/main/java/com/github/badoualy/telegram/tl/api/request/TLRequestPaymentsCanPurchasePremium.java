 ...
 */
public class TLRequestPaymentsCanPurchasePremium extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLAbsInputStorePaymentPurpose purpose;

    private final String _constructor = "payments.canPurchasePremium#0";

    public TLRequestPaymentsCanPurchasePremium() {
    }

    public TLRequestPaymentsCanPurchasePremium(TLAbsInputStorePaymentPurpose purpose) {
