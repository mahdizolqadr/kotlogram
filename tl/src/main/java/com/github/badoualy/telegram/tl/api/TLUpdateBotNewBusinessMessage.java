 ...
 */
public class TLUpdateBotNewBusinessMessage extends TLAbsUpdate {
    ...
    private final String _constructor = "updateBotNewBusinessMessage#0";

    public TLUpdateBotNewBusinessMessage() {
    }

    public TLUpdateBotNewBusinessMessage(String connectionId, TLAbsMessage message, TLAbsMessage replyToMessage, int qts) {
