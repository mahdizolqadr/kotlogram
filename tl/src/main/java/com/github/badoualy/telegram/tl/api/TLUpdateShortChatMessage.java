...
public class TLUpdateShortChatMessage extends TLAbsUpdates {
    ...
    public TLUpdateShortChatMessage(boolean out, boolean mentioned, boolean mediaUnread, boolean silent, int id, long fromId, long chatId, String message, int pts, int ptsCount, int date, TLMessageFwdHeader fwdFrom, Long viaBotId, TLAbsMessageReplyHeader replyTo, TLVector<TLAbsMessageEntity> entities, Integer ttlPeriod) {
        this.out = out;
