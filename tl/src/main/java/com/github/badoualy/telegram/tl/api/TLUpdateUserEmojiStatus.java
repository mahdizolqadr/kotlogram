 ...
 */
public class TLUpdateUserEmojiStatus extends TLAbsUpdate {
    ...
    private final String _constructor = "updateUserEmojiStatus#0";

    public TLUpdateUserEmojiStatus() {
    }

    public TLUpdateUserEmojiStatus(long userId, TLAbsEmojiStatus emojiStatus) {
        this.userId = userId;
