 ...
 */
public class TLInputBusinessGreetingMessage extends TLObject {
    ...
    private final String _constructor = "inputBusinessGreetingMessage#0";

    public TLInputBusinessGreetingMessage() {
    }

    public TLInputBusinessGreetingMessage(int shortcutId, TLInputBusinessRecipients recipients, int noActivityDays) {
