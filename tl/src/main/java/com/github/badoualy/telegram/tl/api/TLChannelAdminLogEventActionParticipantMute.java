 ...
 */
public class TLChannelAdminLogEventActionParticipantMute extends TLAbsChannelAdminLogEventAction {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLGroupCallParticipant participant;

    private final String _constructor = "channelAdminLogEventActionParticipantMute#0";

    public TLChannelAdminLogEventActionParticipantMute() {
    }

    public TLChannelAdminLogEventActionParticipantMute(TLGroupCallParticipant participant) {
