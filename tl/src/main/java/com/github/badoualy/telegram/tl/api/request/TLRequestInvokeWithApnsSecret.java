 ...
 */
public class TLRequestInvokeWithApnsSecret<T extends TLObject> extends TLMethod<T> {
    ...
    private final String _constructor = "invokeWithApnsSecret#0";

    public TLRequestInvokeWithApnsSecret() {
    }

    public TLRequestInvokeWithApnsSecret(String nonce, String secret, TLMethod<T> query) {
        this.nonce = nonce;
        this.secret = secret;
        this.query = query;
    }
