 ...
 */
public class TLRequestMessagesDeleteSavedHistory extends TLMethod<TLAffectedHistory> {
    ...
    private final String _constructor = "messages.deleteSavedHistory#0";

    public TLRequestMessagesDeleteSavedHistory() {
    }

    public TLRequestMessagesDeleteSavedHistory(TLAbsInputPeer peer, int maxId, Integer minDate, Integer maxDate) {
        this.peer = peer;
        this.maxId = maxId;
