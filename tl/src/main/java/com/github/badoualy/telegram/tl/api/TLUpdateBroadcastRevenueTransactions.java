 ...
 */
public class TLUpdateBroadcastRevenueTransactions extends TLAbsUpdate {
    ...
    private final String _constructor = "updateBroadcastRevenueTransactions#0";

    public TLUpdateBroadcastRevenueTransactions() {
    }

    public TLUpdateBroadcastRevenueTransactions(TLAbsPeer peer, TLBroadcastRevenueBalances balances) {
        this.peer = peer;
