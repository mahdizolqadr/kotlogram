 ...
 */
public class TLRequestContactsImportContactToken extends TLMethod<TLAbsUser> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected String token;

    private final String _constructor = "contacts.importContactToken#0";

    public TLRequestContactsImportContactToken() {
    }

    public TLRequestContactsImportContactToken(String token) {
        this.token = token;
    }
