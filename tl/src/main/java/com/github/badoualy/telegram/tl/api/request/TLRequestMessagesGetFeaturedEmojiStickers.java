 ...
 */
public class TLRequestMessagesGetFeaturedEmojiStickers extends TLMethod<TLAbsFeaturedStickers> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected long hash;

    private final String _constructor = "messages.getFeaturedEmojiStickers#0";

    public TLRequestMessagesGetFeaturedEmojiStickers() {
    }

    public TLRequestMessagesGetFeaturedEmojiStickers(long hash) {
        this.hash = hash;
    }
