 ...
 */
public class TLRequestSmsjobsUpdateSettings extends TLMethod<TLBool> {
    ...
    private final String _constructor = "smsjobs.updateSettings#0";

    public TLRequestSmsjobsUpdateSettings() {
    }

    public TLRequestSmsjobsUpdateSettings(boolean allowInternational) {
