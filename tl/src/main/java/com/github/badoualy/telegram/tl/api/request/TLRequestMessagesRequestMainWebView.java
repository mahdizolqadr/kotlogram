 ...
 */
public class TLRequestMessagesRequestMainWebView extends TLMethod<TLWebViewResultUrl> {
    ...
    private final String _constructor = "messages.requestMainWebView#0";

    public TLRequestMessagesRequestMainWebView() {
    }

    public TLRequestMessagesRequestMainWebView(boolean compact, boolean fullscreen, TLAbsInputPeer peer, TLAbsInputUser bot, String startParam, TLDataJSON themeParams, String platform) {
