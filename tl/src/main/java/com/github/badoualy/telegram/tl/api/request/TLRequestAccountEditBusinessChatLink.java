 ...
 */
public class TLRequestAccountEditBusinessChatLink extends TLMethod<TLBusinessChatLink> {
    ...
    private final String _constructor = "account.editBusinessChatLink#0";

    public TLRequestAccountEditBusinessChatLink() {
    }

    public TLRequestAccountEditBusinessChatLink(String slug, TLInputBusinessChatLink link) {
        this.slug = slug;
        this.link = link;
    }
