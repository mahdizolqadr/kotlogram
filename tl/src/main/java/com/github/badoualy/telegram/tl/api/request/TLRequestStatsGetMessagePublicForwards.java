 ...
 */
public class TLRequestStatsGetMessagePublicForwards extends TLMethod<TLPublicForwards> {
    ...
    private final String _constructor = "stats.getMessagePublicForwards#0";

    public TLRequestStatsGetMessagePublicForwards() {
    }

    public TLRequestStatsGetMessagePublicForwards(TLAbsInputChannel channel, int msgId, String offset, int limit) {
