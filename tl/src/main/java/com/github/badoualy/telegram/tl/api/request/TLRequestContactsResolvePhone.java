 ...
 */
public class TLRequestContactsResolvePhone extends TLMethod<TLResolvedPeer> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected String phone;

    private final String _constructor = "contacts.resolvePhone#0";

    public TLRequestContactsResolvePhone() {
    }

    public TLRequestContactsResolvePhone(String phone) {
        this.phone = phone;
    }
