 ...
 */
public class TLEmojiGroupGreeting extends TLAbsEmojiGroup {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLStringVector emoticons;

    private final String _constructor = "emojiGroupGreeting#0";

    public TLEmojiGroupGreeting() {
    }

    public TLEmojiGroupGreeting(String title, long iconEmojiId, TLStringVector emoticons) {
        this.title = title;
