 ...
 */
public class TLRequestMessagesGetDefaultTagReactions extends TLMethod<TLAbsReactions> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected long hash;

    private final String _constructor = "messages.getDefaultTagReactions#0";

    public TLRequestMessagesGetDefaultTagReactions() {
    }

    public TLRequestMessagesGetDefaultTagReactions(long hash) {
        this.hash = hash;
    }
