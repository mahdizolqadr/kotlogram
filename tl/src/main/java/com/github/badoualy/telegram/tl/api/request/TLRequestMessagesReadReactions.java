 ...
 */
public class TLRequestMessagesReadReactions extends TLMethod<TLAffectedHistory> {
    ...
    private final String _constructor = "messages.readReactions#0";

    public TLRequestMessagesReadReactions() {
    }

    public TLRequestMessagesReadReactions(TLAbsInputPeer peer, Integer topMsgId) {
        this.peer = peer;
