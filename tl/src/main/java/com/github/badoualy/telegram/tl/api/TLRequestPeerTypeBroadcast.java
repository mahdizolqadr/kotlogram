 ...
 */
public class TLRequestPeerTypeBroadcast extends TLAbsRequestPeerType {
    ...
    private final String _constructor = "requestPeerTypeBroadcast#0";

    public TLRequestPeerTypeBroadcast() {
    }

    public TLRequestPeerTypeBroadcast(boolean creator, boolean hasUsername, TLChatAdminRights userAdminRights, TLChatAdminRights botAdminRights) {
