 ...
 */
public class TLRequestMessagesReorderPinnedSavedDialogs extends TLMethod<TLBool> {
    ...
    private final String _constructor = "messages.reorderPinnedSavedDialogs#0";

    public TLRequestMessagesReorderPinnedSavedDialogs() {
    }

    public TLRequestMessagesReorderPinnedSavedDialogs(boolean force, TLVector<TLAbsInputDialogPeer> order) {
        this.force = force;
        this.order = order;
    }
