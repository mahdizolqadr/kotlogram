 ...
 */
public class TLRequestPaymentsGetConnectedStarRefBot extends TLMethod<TLConnectedStarRefBots> {
    ...
    private final String _constructor = "payments.getConnectedStarRefBot#0";

    public TLRequestPaymentsGetConnectedStarRefBot() {
    }

    public TLRequestPaymentsGetConnectedStarRefBot(TLAbsInputPeer peer, TLAbsInputUser bot) {
        this.peer = peer;
        this.bot = bot;
    }
