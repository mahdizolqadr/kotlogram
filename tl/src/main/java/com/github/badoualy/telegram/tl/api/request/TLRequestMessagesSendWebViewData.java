 ...
 */
public class TLRequestMessagesSendWebViewData extends TLMethod<TLAbsUpdates> {
    ...
    private final String _constructor = "messages.sendWebViewData#0";

    public TLRequestMessagesSendWebViewData() {
    }

    public TLRequestMessagesSendWebViewData(TLAbsInputUser bot, long randomId, String buttonText, String data) {
        this.bot = bot;
