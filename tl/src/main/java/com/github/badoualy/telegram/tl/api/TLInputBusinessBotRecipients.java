 ...
 */
public class TLInputBusinessBotRecipients extends TLObject {
    ...
    protected TLVector<TLAbsInputUser> excludeUsers;

    private final String _constructor = "inputBusinessBotRecipients#0";

    public TLInputBusinessBotRecipients() {
    }

    public TLInputBusinessBotRecipients(boolean existingChats, boolean newChats, boolean contacts, boolean nonContacts, boolean excludeSelected, TLVector<TLAbsInputUser> users, TLVector<TLAbsInputUser> excludeUsers) {
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        excludeUsers = (flags & 64) != 0 ? readTLVector(stream, context) : null;
    }
    ...
    public TLVector<TLAbsInputUser> getExcludeUsers() {
        return excludeUsers;
    }

    public void setExcludeUsers(TLVector<TLAbsInputUser> excludeUsers) {
        this.excludeUsers = excludeUsers;
    }
}
