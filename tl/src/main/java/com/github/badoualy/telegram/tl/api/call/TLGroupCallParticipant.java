...
public class TLGroupCallParticipant extends TLObject {
    ...
    public TLGroupCallParticipant(boolean muted, boolean left, boolean canSelfUnmute, boolean justJoined,
                                  boolean versioned, boolean min, boolean mutedByYou, boolean volumeByAdmin,
                                  boolean self, boolean videoJoined, TLAbsPeer peer, int date, Integer activeDate,
                                  int source, Integer volume, String about, Long raiseHandRating,
                                  TLGroupCallParticipantVideo video, TLGroupCallParticipantVideo presentation) {
        this.muted = muted;
        this.left = left;
    ...
    public void serializeBody(OutputStream stream) throws IOException {
        ...
        if ((flags & 8) != 0) {
            if (activeDate == null) {
                throwNullFieldException("activeDate", flags);
            }
        ...
        if ((flags & 128) != 0) {
            if (volume == null) {
                throwNullFieldException("volume", flags);
            }
            writeInt(volume, stream);
        }
        if ((flags & 2048) != 0) {
            if (about == null) {
                throwNullFieldException("about", flags);
            }
            writeString(about, stream);
        }
        if ((flags & 8192) != 0) {
            if (raiseHandRating == null) {
                throwNullFieldException("raiseHandRating", flags);
            }
            writeLong(raiseHandRating, stream);
        }
        if ((flags & 64) != 0) {
            if (video == null) {
                throwNullFieldException("video", flags);
            }
            writeTLObject(video, stream);
        }
        if ((flags & 16384) != 0) {
            if (presentation == null) {
                throwNullFieldException("presentation", flags);
            }
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        video = (flags & 64) != 0
                ? readTLObject(stream, context, TLGroupCallParticipantVideo.class, TLGroupCallParticipantVideo.CONSTRUCTOR_ID)
                : null;
        presentation = (flags & 16384) != 0
                ? readTLObject(stream, context, TLGroupCallParticipantVideo.class, TLGroupCallParticipantVideo.CONSTRUCTOR_ID)
                : null;
    }
    ...
    public boolean isCanSelfUnmute() {
    ...
    public boolean isVolumeByAdmin() {
