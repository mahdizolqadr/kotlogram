 ...
 */
public class TLMediaAreaVenue extends TLAbsMediaArea {
    ...
    private final String _constructor = "mediaAreaVenue#0";

    public TLMediaAreaVenue() {
    }

    public TLMediaAreaVenue(TLMediaAreaCoordinates coordinates, TLAbsGeoPoint geo, String title, String address, String provider, String venueId, String venueType) {
