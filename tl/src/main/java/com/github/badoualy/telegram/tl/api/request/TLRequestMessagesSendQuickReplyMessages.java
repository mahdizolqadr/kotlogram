 ...
 */
public class TLRequestMessagesSendQuickReplyMessages extends TLMethod<TLAbsUpdates> {
    ...
    private final String _constructor = "messages.sendQuickReplyMessages#0";

    public TLRequestMessagesSendQuickReplyMessages() {
    }

    public TLRequestMessagesSendQuickReplyMessages(TLAbsInputPeer peer, int shortcutId, TLIntVector id, TLLongVector randomId) {
        this.peer = peer;
