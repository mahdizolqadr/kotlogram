 ...
 */
public class TLUpdateQuickReplyMessage extends TLAbsUpdate {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLAbsMessage message;

    private final String _constructor = "updateQuickReplyMessage#0";

    public TLUpdateQuickReplyMessage() {
    }

    public TLUpdateQuickReplyMessage(TLAbsMessage message) {
