 ...
 */
public class TLChannelAdminLogEventActionChangePeerColor extends TLAbsChannelAdminLogEventAction {
    ...
    private final String _constructor = "channelAdminLogEventActionChangePeerColor#0";

    public TLChannelAdminLogEventActionChangePeerColor() {
    }

    public TLChannelAdminLogEventActionChangePeerColor(TLPeerColor prevValue, TLPeerColor newValue) {
