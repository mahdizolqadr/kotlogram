...
public class TLInputChatUploadedPhoto extends TLAbsInputChatPhoto {
    ...
    public TLInputChatUploadedPhoto(TLAbsInputFile file, TLAbsInputFile video, Double videoStartTs, TLAbsVideoSize videoEmojiMarkup) {
        this.file = file;
        this.video = video;
    ...
    private void computeFlags() {
        ...
        flags = videoEmojiMarkup != null ? (flags | 8) : (flags & ~8);
    }
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        videoEmojiMarkup = (flags & 8) != 0 ? readTLObject(stream, context, TLAbsVideoSize.class, -1) : null;
    }
