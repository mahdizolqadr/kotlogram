 ...
 */
public class TLRequestMessagesGetEmojiStickers extends TLMethod<TLAbsAllStickers> {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected long hash;

    private final String _constructor = "messages.getEmojiStickers#0";

    public TLRequestMessagesGetEmojiStickers() {
    }

    public TLRequestMessagesGetEmojiStickers(long hash) {
        this.hash = hash;
    }
