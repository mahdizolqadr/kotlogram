...
public class TLRequestMessagesSetInlineBotResults extends TLMethod<TLBool> {
    ...
    public TLRequestMessagesSetInlineBotResults(boolean gallery, boolean _private, long queryId, TLVector<TLAbsInputBotInlineResult> results, int cacheTime, String nextOffset, TLInlineBotSwitchPM switchPm, TLInlineBotWebView switchWebview) {
    ...
    private void computeFlags() {
        ...
        flags = switchWebview != null ? (flags | 16) : (flags & ~16);
    }
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        switchWebview = (flags & 16) != 0 ? readTLObject(stream, context, TLInlineBotWebView.class, TLInlineBotWebView.CONSTRUCTOR_ID) : null;
    }
