 ...
 */
public class TLStickerSetNoCovered extends TLAbsStickerSetCovered {
    public static final int CONSTRUCTOR_ID = 0x0;

    private final String _constructor = "stickerSetNoCovered#0";

    public TLStickerSetNoCovered() {
    }

    public TLStickerSetNoCovered(TLStickerSet set) {
        this.set = set;
    }
