 ...
 */
public class TLStoryReactionPublicForward extends TLAbsStoryReaction {
    public static final int CONSTRUCTOR_ID = 0x0;

    protected TLAbsMessage message;

    private final String _constructor = "storyReactionPublicForward#0";

    public TLStoryReactionPublicForward() {
    }

    public TLStoryReactionPublicForward(TLAbsMessage message) {
