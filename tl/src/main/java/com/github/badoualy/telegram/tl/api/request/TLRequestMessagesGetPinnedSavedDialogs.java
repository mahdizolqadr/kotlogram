 ...
 */
public class TLRequestMessagesGetPinnedSavedDialogs extends TLMethod<TLAbsSavedDialogs> {
    public static final int CONSTRUCTOR_ID = 0x0;

    private final String _constructor = "messages.getPinnedSavedDialogs#0";

    public TLRequestMessagesGetPinnedSavedDialogs() {
    }
